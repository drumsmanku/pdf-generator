...
function Register() {
  ...
  return (
    <div className="flex flex-col h-screen justify-between items-center">
      ...
      <form className="border-2 border-gray-300 rounded-lg w-1/3 md:w-2/5">
        ...
        <div className="w-full flex justify-center">
          <p className="w-4/5 text-sm text-left mt-0 font-semibold" style={{ fontWeight: 600, fontSize: 'small' }}>
            By enrolling your mobile phone number, you consent to receive automated security notifications via text message from Musicart. Message
      ...
      <footer className="bg-purple-900 w-full p-2 text-white mt-1">
