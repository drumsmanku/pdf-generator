...
function DownloadPage() {
  ...
  const handleGeneratePDF = async () => {
    ...
    try {
      const response = await axios.post('https://pdf-generator-xyuv.onrender.com/generate-pdf', { htmlContent },{ responseType: 'blob' });
  ...
  return (
    <div className='h-screen w-screen'>
      ...
      <div id="downloadButtonContainer" style={{ width: '45%', display:'flex', justifyContent:'center' }}>
        <button
      ...
      <style>
        ...
        <div className='black-back w-[80%] lg:w-[60%] bg-black px-16 py-8 rounded-[3rem] text-md text-white  '>
