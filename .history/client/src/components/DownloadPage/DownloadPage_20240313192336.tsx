...
function DownloadPage() {
  ...
  const handleGeneratePDF = async () => {
    try {
      const response = await axios.post('http://localhost:4000/generate-pdf',  products,{ responseType: 'blob' });
  ...
  return (
    <div className='h-screen w-screen'>
      ...
      <div className='w-full flex justify-center pl-12 md:pl-24 mt-12'>
      ...
      <div className='w-full flex justify-center mt-12'>
        <div className='w-[60%] bg-black px-16 py-8 rounded-[3rem] text-md text-white  '>
