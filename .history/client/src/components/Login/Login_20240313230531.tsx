...
function Login() {
  ...
  const login = (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    axios
      .post('https://pdf-generator-xyuv.onrender.com/login', user)
      .then((res) => {
          ...
          <div className="flex flex-col items-center p-4">
            ...
            <div style={DivStyles}>
              ...
              <input
                ...
                style={InputStyles}
                className="w-full p-2 mt-1 border-b-2 outline-none border-gray-300 rounded-lg"
              />
            </div>
            <div style={DivStyles}>
              ...
              <input
                ...
                onChange={handleChange}
                style={InputStyles}
                className="w-full p-2 mt-1 outline-none border-gray-300 rounded-lg"
              />
            </div>
