  ...
  return (
    <div >
      <header>
          ...
          <div className="w-full h-full flex justify-center items-center" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }} >
            <div className="bg-white my-15 mx-auto w-[70%] lg:w-full rounded-md">
              
              <div className="flex justify-between">
             
              <form className="modalAddBodyLeft flex flex-col w=[100%] lg:w-[55%] p-12 gap-10">
              <h2 className='font-bold'>Add Product </h2>
                ...
                <div className="flex flex-col w-full pl-4 lg:w-[40%] text-white p-16 bg-[#36416A]">
