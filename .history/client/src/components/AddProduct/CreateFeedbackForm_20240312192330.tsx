          ...
          <div className={styles.modalAdd} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }} >
            <div className={styles.modalAddContent}>
              ...
              <h2>Create Feedback </h2>
                ...
                <div style={{width:'85%'}}>
                  <button className="px-4 py-1.5 text-white h-8 text-md rounded-full border-none bg-blue-700 mt-8 " type="submit" style={{ cursor:'pointer'}} onClick={sendProd}>Create</button>
