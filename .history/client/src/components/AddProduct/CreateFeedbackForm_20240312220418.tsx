  ...
  return (
    <div className={styles.container}>
      <header className={styles.header}>
          ...
          <div className="fixed z-10 inset-0 bg-black bg-opacity-60 modalAdd" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }} >
            <div className="bg-white mx-auto my-15p w-50 modalAddContent">
              
              <div className="flex justify-between modalAddBody">
             
              <form className="flex flex-col w-55p p-3rem">
              <h2>Create Feedback </h2>
                ...
                <div style={{width:'85%'}}>
                  <button className="px-4 py-1.5 text-white h-8 text-md rounded-full border-none bg-[#36416A] mt-8 " type="submit" style={{ cursor:'pointer'}} onClick={sendProd}>Create</button>
