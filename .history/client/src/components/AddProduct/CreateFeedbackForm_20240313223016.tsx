  ...
  return (
    <div >
      <header>
          ...
          <div className="w-[80%] h-full" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh' }} >
            <div className="bg-white my-15 mx-auto w-full lg:w-full rounded-md">
