      ...
      case 2:
        return (
          <div className={styles.thirdSlide}>
            ...
            {!isAgeLessThan40 && (
              <label style={{fontSize:'small', display:'flex', color:'#c2d5e8',alignItems:'center'}}>
                Previous experience with physiotherapy
                <input style={{height:'1rem'}} type="checkbox" name="previousExperience" checked={formData.previousExperience} onChange={handleInputChange} />
