...
interface FormProps {
  ...
  onClick?: (e: React.MouseEvent<HTMLDivElement, MouseEvent>) => void; // This line is added to include the onClick prop
}
const FormPopup = ({ onFormSubmit, onClick }: FormProps) => {
  ...
  return (
    <div ref={formRef} className={styles.formContainer} onClick={onClick}>
