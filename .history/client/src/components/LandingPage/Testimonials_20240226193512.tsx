...
const tetStyles="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3"

const stars=['', '', '', '', '',]
function Testimonials() {
  return (
    <div className={styles.testimonialContainer}>
      <section className="py-12 bg-gray-50 sm:py-16 lg:py-20 h-full">
    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex flex-col items-center">
            <div className="text-center">
                <p className="text-lg font-medium text-gray-600 font-pj">2,157 people have said how good FixHealth</p>
                        ...
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“Your assessment method is so good & patient support resolves issues promptly.”</p>
                                </blockquote>
                            </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“Quality, pocket friendly & consistent care is what Fix Health stands for”</p>
                                </blockquote>
                            </div>
                    ...
                    <div className="flex flex-col overflow-hidden shadow-xl">
                        <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                            <div className="flex-1">
                                ...
                                <blockquote className="flex-1 mt-8">
                                    <p className="text-lg leading-relaxed text-gray-900 font-pj">“They worked around time zone variations to accommodate my schedule”</p>
                                </blockquote>
                            </div>
